...
func initTestPassword() (*bbolt.DB, response.Login, request.Register, func()) {
	...
	// Puedes continuar agregando datos de prueba según sea necesario.

	return db, rspL, rRegister, cleanup
}
