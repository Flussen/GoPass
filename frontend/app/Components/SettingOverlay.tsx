        ...
        <div id="Options" className="fixed flex flex-col justify-between 2xl:w-[20%] w-[100px]  bg-darkgray  rounded-lg   ml-8 mt-8 mb-8 pt-[0.5rem] h-[92%] ">
            <div className="flex-col justify-center w-full   px-[20px]  space-y-[3rem]">
                ...
                <div className="space-y-2">
                    <div className={`flex items-center 2xl:justify-start justify-center 2xl:pl-[10%] h-14 rounded-2xl  space-x-2 cursor-pointer  font-semibold 2xl:text-xl  ${true ? ' text-green max-2xl:bg-gray' : 'text-gray  hover:text-whitegray'}`}>
